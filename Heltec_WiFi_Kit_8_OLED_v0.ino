/*
 * Library: https://www.arduinolibraries.info/libraries/u8g2 
 * Code: https://robotzero.one/heltec-wifi-kit-8/
*/
#include <U8g2lib.h>
...
//const char *text = "SP_Mini_Project_v2 "; // scroll this text from right to left
